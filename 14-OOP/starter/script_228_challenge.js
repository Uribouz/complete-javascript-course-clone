...
//Chapter: 224 Encapsulation properties

const acct1 = new Account('Jonas', 'EUR', 1111);
console.log(acct1);
// acct1._movements.push(250); //should not use _movements like this.
// acct1._movements.push(-140); //should not use _movements like this.
acct1.deposit(250);
acct1.withdraw(140);
...
//Chapter 226: Chaining Methods

acct1.deposit(300).deposit(500).withdraw(35).requestLoan(25000).withdraw(4000);
console.log(acct1.getMovements());

//Chapter 227: Class Summary

// * Watch the video.

//1. Classes are just 'syntatic sugar' over constructor functions.
//2. Classes are not hoisted
//3. Classes are 'first-class' citizens
//4. Class body is always executed in struct mode.
...
rivian.accelerate().accelerate().accelerate().brake().chargeBattery(55).brake().brake();
