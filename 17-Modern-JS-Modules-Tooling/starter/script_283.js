...
* - Use tenary (conditional) or logical operators instead of 'if'
* - Use multiple 'if' instead of 'if/else-if'
* - Avoid 'for' loops, use array methods instead
* - Avoid callback based asynchronous APIs
* - Consome progmises with async/await for best readability
* - Whenever possible, run promise in parllel (Promise.all)
* - Handle errors and promise rejections.
*/

/* Chapter 283:
?    A. Two fundametally different ways to writing code (paradigms)
        1) Imperative
            - Programmer explains "How to do things"
            - We explian the computer every single step it has to follow to achieve a result
            - Example: Step-By-step recipe of a cake
        2) Declarative
            - Programmer tells "What to do"
            - We simple describe the way the compter should achieve the result
...
*       - Pure function: Function without side effects. Does not depend on external variables. Given the same inpts, always returns the same outputs.
