...
1. Create a method called 'registerNewAnswer' on the 'poll' object. The method does 2 things:
  ...
  For example, if the option is 3, increase the value AT POSITION 3 of the array 
  by 1. Make sure to check if the input is a number and if the number makes sense 
...
const poll = {
  ...
  registerNewAnswer: function() {
    ...
    if ( answer < 0 || answer >= this.answers.length ) {
      console.log('More than accpeted answer');
      return;
    }
