...
//3
const gameTotalTime = 90;
console.log(`An event happened, on average, 
every ${gameTotalTime/gameEvents.size} minutes`)

//4
const gameHalfTime = gameTotalTime/2;
for (const [time, event] of gameEvents) {
  console.log(`${time > gameHalfTime ? "[SECOND HALF]":"[FIRST HALF]"} ${time}: ${event}`);
}